...
# important functions
# This function clears the digits from the last position,it is used to rectify the errors if done by the user
def clear():
    ex = textField.get()
    ex = ex[0:len(ex) - 1]
...
# This function is used to clear all data from the screen of the calculator
def all_clear():
    textField.delete(0, END)
